...
#
# (Non Administrator Required)
#
# Usage Examples
# On Powershell
# iex ((New-Object System.Net.WebClient).DownloadString('https://mcelebi.net/d'))
#
# On Powershell (TLS/SSL Error)
# [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; iex ((New-Object System.Net.WebClient).DownloadString('https://mcelebi.net/d'))
#
# On Command Prompt
# powershell -ExecutionPolicy Bypass -Command "iex ((New-Object System.Net.WebClient).DownloadString('https://mcelebi.net/d'))"
#
# On Command Prompt (TLS/SSL Error)
# powershell -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; iex ((New-Object System.Net.WebClient).DownloadString('https://1.mcelebi.net/d'))"
